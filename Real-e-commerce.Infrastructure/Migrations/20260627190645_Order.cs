        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAdress_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAdress_Line1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAdress_Line2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PaymentSummery_Last4 = table.Column<int>(type: "int", nullable: false),
                    PaymentSummery_Brand = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentSummery_ExpMonth = table.Column<int>(type: "int", nullable: false),
                    PaymentSummery_ExpYear = table.Column<int>(type: "int", nullable: false),
